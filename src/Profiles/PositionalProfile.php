...
abstract class PositionalProfile extends Profile
{
    ...
    /** How far into a file a heading row may sit. See HeaderDrivenProfile for why it is bounded. */
    ...
    {
        foreach (array_slice($document->rows, 0, self::HEADING_SEARCH_LIMIT) as $row) {
            $found = [];
